...
class OPI_RSS_Blocks {
    ...
    public static function register_blocks(): void {
        ...
        register_block_type( 'opi-rss/recent-items', [
            ...
            'render_callback' => [ __CLASS__, 'render_recent_items' ],
            'attributes'      => [
                'limit' => [
                    'type'    => 'number',
                    'default' => 20,
        ...
        register_block_type( 'opi-rss/active-sources', [
            ...
            'render_callback' => [ __CLASS__, 'render_active_sources' ],
        ] );
    }

    public static function render_recent_items( array $attributes ): string {
                    ...
                    <?php foreach ( $items as $item ) : ?>
                        <li class="wpra-item feed-item" style="margin-bottom:20px;">
                            ...
                            <div class="wprss-feed-meta" style="font-size:0.9em;color:#666;margin-top:5px;">
                                ...
                                <span class="time-ago">
                                    | <?php printf( __( 'Published %s', 'opi-rss' ), esc_html( OPI_RSS::time_diff( $item->pub_date ) ) ); ?>
                                </span>
                            </div>
                        </li>
                    <?php endforeach; ?>
    ...
    public static function render_active_sources( array $attributes ): string {
